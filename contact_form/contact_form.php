...
// configure
$from = 'info@talbiyoussef.com'; // Replace it with Your Hosting Admin email. REQUIRED!
$sendTo = 'talbi.bus@gmail.com'; // Replace it with Your email. REQUIRED!
...
if(isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])):
    ...
    $secret = '6LcOqd0ZAAAAAAjsd5hzu1ZsIIF-u8knQpOLFpZ7';
